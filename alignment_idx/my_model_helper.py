...
__all__ = [
    "get_initializer", "get_device_str", "create_infer_model",
...
class InferModel(
    collections.namedtuple("InferModel",
                           ("graph",
                            "model",
                            "src_index_placeholder",
                            "trg_index_placeholder",
                            "src_seqlen_placeholder",
                            "trg_seqlen_placeholder",
                            # "src_file_placeholder",
                            # "trg_file_placeholder",
                            "batch_size_placeholder",
                            # "iterator"
                            ))):
    pass
...
def create_infer_model(model_creator, hparams, scope=None, extra_args=None):
    ...
    with graph.as_default(), tf.container(scope or "infer"):
        ...
        holders = [src_index_placeholder, trg_index_placeholder, src_seqlen_placeholder, trg_seqlen_placeholder]
        batch_size_placeholder = tf.placeholder(shape=[], dtype=tf.int64)
        model = model_creator(
            hparams,
            # iterator=iterator,
    ...
    return InferModel(
        graph=graph,
        model=model,
        src_index_placeholder=src_index_placeholder,
        trg_index_placeholder=trg_index_placeholder,
        src_seqlen_placeholder=src_seqlen_placeholder,
        trg_seqlen_placeholder=trg_seqlen_placeholder,
        batch_size_placeholder=batch_size_placeholder,
        # src_file_placeholder=src_file_placeholder,
        # trg_file_placeholder=tgt_file_placeholder,
        # batch_size_placeholder=batch_size_placeholder,
        # iterator=iterator
        )
