...
def create_infer_model(model_creator, hparams, scope=None, extra_args=None):
    ...
    with graph.as_default(), tf.container(scope or "infer"):
        ...
        src_index_placeholder = tf.placeholder(shape=[None, None], dtype=tf.int32, name="src_placeholder")
        trg_index_placeholder = tf.placeholder(shape=[None, None], dtype=tf.int32, name="trg_placeholder")
        holders = [src_index_placeholder, trg_index_placeholder]
        model = model_creator(
            hparams,
